...
func TestDataSourceApplication(t *testing.T) {
			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.sci_application.testApp", "authentication_schema.default_authenticating_idp", "f2615e9b-5fa6-4680-891d-9f0eb41fff6b"),
	...
	t.Run("happy path - bundled application2", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: providerConfig("", user) + DataSourceApplication("testBundledApp", "XSUAA_b1799d1c-ce91-4cd4-8b6e-dc8f4eaf0ad9"),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestMatchResourceAttr("data.sci_application.testBundledApp", "id", regexpUUID),
						resource.TestCheckResourceAttr("data.sci_application.testBundledApp", "name", "XSUAA_b1799d1c-ce91-4cd4-8b6e-dc8f4eaf0ad9"),
						resource.TestCheckResourceAttr("data.sci_application.testBundledApp", "meta.type", "bundled"),
						resource.TestCheckResourceAttr("data.sci_application.testBundledApp", "authentication_schema.sap_managed_attributes.type", "xsuaa"),
						resource.TestCheckResourceAttr("data.sci_application.testBundledApp", "authentication_schema.sap_managed_attributes.app_tenant_id", "b1799d1c-ce91-4cd4-8b6e-dc8f4eaf0ad9"),
					),
				},
			},
		})
