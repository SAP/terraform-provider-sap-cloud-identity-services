			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("sci_corporate_idp.testIdP", "oidc_config.additional_config.disable_logout_id_token_hint", fmt.Sprintf("%t", oidcCoporateIdP.AdditionalConfig.OmitIDTokenHintForLogout)),
