---
page_title: "sci_application_secrets Data Source - sci"
subcategory: ""
description: |-
...
# sci_application_secrets (Data Source)
...
```terraform
data "sci_application_secrets" "example" {
...
- `api_names` (Set of String) API names the secret is authorized to access.
