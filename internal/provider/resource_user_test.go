			...
			Steps: []resource.TestStep{
				...
				},
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.0.type", updatedSciUser.Emails[1].Type),
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.0.value", updatedSciUser.Emails[1].Value),
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.0.primary", fmt.Sprintf("%t", updatedSciUser.Emails[1].Primary)),
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.1.type", updatedSciUser.Emails[0].Type),
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.1.value", updatedSciUser.Emails[0].Value),
						resource.TestCheckResourceAttr("sci_user.testUser", "emails.1.primary", fmt.Sprintf("%t", updatedSciUser.Emails[0].Primary)),
