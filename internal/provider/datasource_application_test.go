			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.ias_application.testApp", "assertion_attributes.0.attribute_value", "firstName"),
						resource.TestCheckResourceAttr("data.ias_application.testApp", "default_authenticating_idp", "664c660e25cff252c5c202dc"),
						resource.TestCheckResourceAttr("data.ias_application.testApp", "sso_type", "saml2"),
						resource.TestCheckResourceAttr("data.ias_application.testApp", "subject_name_identifier.value", "uid"),
					),
				},
			},
		})
